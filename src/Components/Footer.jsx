            ...
            <div style={{background: 'linear-gradient(120deg, #4286f4, #1ed75fda)'}}>
                <div className='footer'>
                    ...
                    <div className='footerContact'>
                        <h3 className='footerSocialLinks' style={{paddingBottom: '1rem', display: 'flex', justifyContent: 'center'}}>Contact Information:</h3>
                        <div    style={{cursor: 'pointer', marginBottom: '1rem', display: 'flex', flexDirection: 'column', paddingRight: '.5rem', alignItems: 'center'}}
                        ...
                        <div style={{paddingBottom: '1rem', display: 'flex', justifyContent: 'center', alignItems: 'center'}}>
                            <FaPhone style={{paddingRight: '.5rem'}}/><a href='tel:7372260768' style={{color: 'white'}}> +1 (737) 226-0768</a>
                        </div>
                        <div style={{ display: 'flex', justifyContent: 'center', alignItems: 'center'}}>
                            <IoMail style={{fontSize: '1.3rem'}}/>
                            <a href='mailto:risingstarsaustintexas@gmail.com' style={{color: 'white', paddingLeft: '.5rem'}}> RisingStarsAustinTexas@gmail.com</a>
                        </div>
                    </div>
                </div>
