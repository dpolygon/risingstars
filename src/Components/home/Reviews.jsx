...
export default function Reviews() {
    ...
    const getYelpReviews = () => {
        return fetch(`https://get-reviews-47bbwwmbga-uc.a.run.app`)
            .then((res) => res.json())
                ...
                <div style={{display: 'flex', justifyContent: 'space-around'}}>
                    <div className='reviewsContainer'>
                        ...
                        onClick={() => {const urlToOpen = reviewsData.reviews[count].url;
                            ...
                            <img src={reviewsData.reviews[count].user.image_url === null ? "/images/defaultpfp.avif" : reviewsData.reviews[count].user.image_url} style={{borderRadius: '50%', height: '80px', width: '80px'}}></img>
