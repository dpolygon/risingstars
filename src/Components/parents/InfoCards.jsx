                ...
                <li className="info-card">
                    ...
                    <div className="card-content2">
                        <h3 style={{ textAlign: "center", paddingBottom: '1rem'}}>
                            Children should not attend Rising Stars if they are ill and:
                        </h3>
                        <div style={{display: 'flex', flexDirection: 'column', gap: '.5rem', textAlign: 'left'}}>
                            <p className="dot">• Are too sick to comfortably take part in activities, including playing outside.</p>
                            <p className="dot">• Need more care than we can provide without risking the health, safety, and supervision of the other children.</p>
                            <p className="dot">• Have a temperature above 101°F (oral), 100°F (tympanic/ear), or 100°F (axillary/armpit), or 100°F (infrared temporal/forehead), accompanied by behavior changes or other signs of illness.</p>
                            <p className="dot">• Signs of severe illness such as lethargy, abnormal breathing, uncontrolled diarrhea, two or more vomiting episodes in 24 hours, rash with fever, mouth sores with drooling, behavior changes, or other signs indicating severe illness.</p>
                            <p className="dot">• Have been diagnosed with a communicable disease and are still contagious, unless they have medical documentation indicating that they are no longer contagious.</p>
                        </div>
                    </div>
